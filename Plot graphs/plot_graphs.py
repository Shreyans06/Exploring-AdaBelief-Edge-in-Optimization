...
def contour_comparison(cost_fn,beta_1=0.9, beta_2=0.999):
    ...
    path_dict = {"SGD": (xs_momentum, ys_momentum, "b"), "Adam": (xs_adam, ys_adam, "green"),
                 "AdaBelief": (xs_adabelief, ys_adabelief, "pink")}
    plot_path(path_dict, cost_fn, figsize=[10, 10], frames=1500, file_name=cost_fn.__class__.__name__)
...
cost_f = ModulusBeta()
contour_comparison(cost_f,beta_1=0.3,beta_2=0.3)
